var playStateLevel1 = {
    ...
    preload: function() {
        ...
        game.load.spritesheet('buttonhorizontal', 'assets/images/button-horizontal.png',96,64);
    ...
    inputs: function() {
        ...
        // Directions
        if (this.cursors.left.isDown || this.left)  { this.directionPlayer(this.leftVelocity, 'left'); } // Move to left
        else if (this.cursors.right.isDown || this.right) { this.directionPlayer(this.rightVelocity, 'right'); }  // Move to right
    ...
    initMobileInputs: function() {
        ...
        // JUMP
        this.buttonjump = game.add.button(game.camera.width - 120, game.camera.height - 120, 'buttonjump', null, this, 0, 1, 0, 1);
        this.buttonjump.fixedToCamera = true;  //our buttons should stay on the same place

        // LEFT
        this.buttonleft = game.add.button(20, game.camera.height - 100, 'buttonhorizontal', null, this, 0, 1, 0, 1);
        ...
        // RIGHT
        this.buttonright = game.add.button(160, game.camera.height - 100, 'buttonhorizontal', null, this, 0, 1, 0, 1);
    ...
    upInputIsActive: function(duration) {
        ...
        game.input.activePointer.x > this.camera.width - 120 &&
        game.input.activePointer.x < (this.camera.width - 120) + this.buttonjump.width &&
        game.input.activePointer.y > this.camera.height - 120 &&
        game.input.activePointer.y < (this.camera.height) - 120  + this.camera.height);
