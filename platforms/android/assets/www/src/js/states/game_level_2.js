var playStateLevel2 = {
    ...
    inputs: function() {
        ...
        // Directions
        if (this.cursors.left.isDown || this.left)  { this.directionPlayer(-300, 'left'); } // Move to left
        else if (this.cursors.right.isDown || this.right) { this.directionPlayer(300, 'right'); }  // Move to right
